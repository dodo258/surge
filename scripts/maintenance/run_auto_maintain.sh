...
if ! git diff --quiet; then
  git add custom-rules/*.list legacy/Stash-Full-Overseas.yaml Clash-Hybrid-OurPolicy.yaml Surge-Full-Overseas.conf scripts/maintenance/*.py README.md observations/*.json || true
